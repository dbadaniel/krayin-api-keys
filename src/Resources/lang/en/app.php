    ...
    'admin' => [
        ...
        'api-keys' => [
            ...
            'create' => [
                ...
                'user-help'              => 'The key will operate under this user\'s identity (record authorship and visibility rules: Global, Group, or Individual).',
                'permissions'            => 'Key Access Scope',
                'all-permissions'        => 'Inherit all user permissions (Recommended)',
                'all-permissions-help'   => 'The key will have access to everything this user is permitted to do in the CRM.',
                'custom-permissions'     => 'Restrict scopes for this Key (Optional)',
                'custom-permissions-help' => 'Limits the key to specific API modules and operations as an extra security boundary.',
        ...
        'datagrid' => [
            ...
            'all'          => 'Inherits from User',
            'custom'       => 'Restricted (:count scopes)',
