    ...
    'admin' => [
        ...
        'api-keys' => [
            ...
            'create' => [
                ...
                'user-help'              => 'A chave operará sob a identidade deste usuário (autoria de registros e regras de visibilidade: Global, Grupo ou Individual).',
                'permissions'            => 'Escopo de Acesso da Chave de API',
                'all-permissions'        => 'Herdar permissões do Usuário (Recomendado)',
                'all-permissions-help'   => 'A chave poderá realizar tudo o que o perfil deste usuário tiver acesso no CRM.',
                'custom-permissions'     => 'Restringir escopos desta Chave (Opcional)',
                'custom-permissions-help' => 'Limita a chave a módulos e operações específicas da API, agindo como trava de segurança adicional.',
        ...
        'datagrid' => [
            ...
            'name'         => 'Nome da Chave',
            'user'         => 'Usuário / Login',
            'permissions'  => 'Permissões da Chave',
            'all'          => 'Herda do Usuário',
            'custom'       => 'Restrito (:count escopos)',
